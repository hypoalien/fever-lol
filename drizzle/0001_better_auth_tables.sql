...
--> statement-breakpoint
--> Hand-edited: Postgres cannot cast timestamp to boolean on its own. A
--> non-null verification timestamp means the address was verified.
...
--> Hand-edited: backfill before adding NOT NULL, or existing null names abort it.
